            ...
            <section class="wrapper">
             ...
             <div class="col-md-7">
                <div class="content-box-large ">
                  {!! Form::open(['url' => 'editProduct',  'method' => 'post']) !!}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-8">
                          <br>  Category:  <select name="cat_id" class="form-control">
                                @foreach($cats as $cat)
                                <option value="{{$cat->name}}" <?php if ($product->cat_name == $cat->id) { ?> selected="selected"<?php } ?>>{{ucwords($cat->name)}}</option>
                                @endforeach
                            </select>
                            <br/>
                            <input type="hidden" name="id" class="form-control" value="{{$product->id}}">
                            Name:    <input type="text" name="pro_name" class="form-control" value="{{$product->name}}">
                            <br/>
                            Price     <input type="text" name="pro_price" class="form-control" value="{{$product->price}}">
                            <br/>
                            Code:    <input type="text" name="pro_code" class="form-control" value="{{$product->code}}">
                            <br/>
                            Sale price: <input type="text" name="spl_price" class="form-control"
                             value="{{$product->spl_price}}">
                            <br/>
                            Details:  <textarea name="pro_info" class="form-control" rows="2">{{$product->info}}</textarea>
                            <br/>
                  ...
                  <div class="panel-heading">
                   ...
                   <div class="content-box-large">
                      ...
                      @foreach($prots as $prot)
                        {!! Form::open(['url' => '/editProperty',  'method' => 'post']) !!}
                      <tr>
                          ...
                          <div class="panel-title">
                            Update Product Image
                               ...
                               alt="" class="img-rounded" width="150px" height="150px"/>
                                   <br> <br>
                                <p><a href="{{url('/EditImage')}}/{{$product->id}}"
