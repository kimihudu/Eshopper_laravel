...
<html lang="en">
    <head>
        ...
        <script src="{{asset('theme/js/jPages.js')}}"></script>
...
<?php $prods = App\Products::all();?>

      $(function(){
         var source = [
             @foreach($prods as $prod)
            { value: "<?php echo url('/');?>/product_details/<?php echo $prod->id;?>",
                label: "<?php echo $prod->name;?>"
            },
            @endforeach
         ];
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                    {{-- <a href="{{url('/WishList')}}"><i class="fa fa-star"></i> Wishlist <span style="color:green; font-weight: bold">({{App\wishList::count()}})</span></a> --}}
                                    </li>
    ...
    <script src="{{asset('theme/js/wish-list.js')}}"></script>
    <script src="{{asset('theme/js/cart.js')}}"></script>
    <script src="{{asset('theme/js/cart-checkout.js')}}"></script>
    {{-- <script src="{{asset('theme/js/searchbox.js')}}"></script> --}}
    </body>
</html>
