        ...
        <div class="row">
                        ...
                        <div class="brands-name">
                              <h2>Category</h2>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <span class="pull-right">({{App\Products::where('cat_name.name',$cat->name)->count()}})</span>
            ...
            <div class="col-sm-9 padding-right"  id="updateDiv" >
                 <div class="features_items"> <!--features_items-->
                      <b> Total Products</b>:  {{$prods->count()}}
                                        ...
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    ...
                                                    <p><a href="{{url('/product_details/'.$product->id)}}"><?php echo $product->name; ?></a></p>
