            ...
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <?php
                                                if(count($cat->sub_cat) > 0){
                                                    ...
                                                    if(is_array($subs)){
                                                    //print_r($subs[0]['name']);
                                                        for($i = 0;$i < count($cat->sub_cat); $i++){
                                                            echo '<li><a data-parent="#accordian" href="#prods">'.$subs[$i]['name'].'</a></li>';
                                                        }
                                                    }
                                                }
                                            ?>
                            ...
                            <div class="brands_products"><!--brands_products-->
                                ...
                                <div class="brands-name">
                                    ...
                                    @foreach($data['brands'] as $brand)
                                        <li><a href="#prods"> <span class="pull-right">{{$brand->qTy}}</span>{{$brand->name}}</a></li>
                                    @endforeach
                                    </ul>
                                </div>
                            </div><!--/brands_products-->
                    ...
                    <div class="col-sm-9 padding-right">
                        <div id="prods" class="features_items" data-service="{{$data['prods']}}"><!--features_items-->
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        ...
                                        <div class="product-overlay">
                                            <a href="<?php echo url('/');?>/product_details/<?php echo $prod['_id'];?>">
